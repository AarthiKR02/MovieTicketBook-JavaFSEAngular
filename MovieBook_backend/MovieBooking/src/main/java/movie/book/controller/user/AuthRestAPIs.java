package movie.book.controller.user;

import movie.book.message.request.ChangePasswordRequest;
import movie.book.message.request.LoginForm;
import movie.book.message.request.SignUpForm;
import movie.book.message.response.JwtResponse;
import movie.book.message.response.ResponseMessage;
import movie.book.model.user.Role;
import movie.book.model.user.RoleName;
import movie.book.model.user.User;
import movie.book.repository.user.RoleRepository;
import movie.book.repository.user.UserRepository;
import movie.book.security.jwt.JwtProvider;
...
public class AuthRestAPIs {
    ...
    public ResponseEntity<?> changePassword(@RequestBody ChangePasswordRequest request) {
        if (!request.getNewPassword().equals(request.getConfirmPassword())) {
            return new ResponseEntity<>(new ResponseMessage("New password and confirm password do not match!"), HttpStatus.BAD_REQUEST);
        }
